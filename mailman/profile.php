                        ...
                        <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return validation()">
                            <div class="row ">
                                <div class="col-md-2 order-md-last mb-3" id="preview">
                                    ...
                                    <img src="<?php echo '../Register_image/' . $row->image; ?>" width="150"
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your first name"
                                                id="fname" name="fname" value="<?php echo $row->fname; ?>" readonly>
                                            <span class="text-danger" id="txtname"></span><br>
                                            <input type="text" class="form-control" placeholder="email(Primary)"
                                                id="email" name="email" value="<?php echo $row->email; ?>" readonly>
                                            ...
                                            <div>
                                                <input type="email" class="form-control" name="remail"
                                                    ...
                                                    value="<?php echo $row->recovery_email; ?>" readonly>

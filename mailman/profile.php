        ...
        <div class="row">
            ...
            <div class="col-sm-4 " style="min-height: 80px; background:antiquewhite;">
                <div class="dropdown mt-2 mx-4">
                    <a class=" btn btn-light btn-lg dropdown-toggle" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <img src="<?php echo '../Register_image/' . $row->image; ?>" width="80" height="80" style="border-radius: 50%;">
                </div>
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return validation()">
                        <div class="row ">
                            ...
                            <div class="col-md-2 order-md-last mb-3" id="preview">
                                ...
                                <img src="<?php echo '../Register_image/' . $row->image; ?>" width="150" height="150" style="border-radius: 50%;">
                            ...
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" placeholder="Enter your first name" id="fname" name="fname" value="<?php echo $row->fname; ?>">
                                        <span class="text-danger" id="txtname"></span><br>
                                        <input type="text" class="form-control" placeholder="email(Primary)" id="email" name="email" value="<?php echo $row->email; ?>">
                                        <span class="text-danger" id="lastname"></span><br>
                                        <div>
                                            <input type="email" class="form-control" name="remail" placeholder="Enter your Email" id="remail" value="<?php echo $row->recovery_email; ?>">
                                            <!-- <span <?php echo $msg ?>></span> -->
                                        </div>
                                        <span class="text-danger" id="useremail"></span><br>
                                        <input type="text" class="form-control" placeholder="Select Username" name="username" id="user" value="<?php echo $row->username; ?>">
                                ...
                                <div class="row ">
                                    <div class="col-md-8">
                                        ...
                                        <a href="../mailman/profile _edit.php?id=<?php echo $row->id ?>">Edit Profile</a>&nbsp;&nbsp;&nbsp;
                                        <a href="../mailman/edit_password.php?id=<?php echo $row->id ?>">Change Password</a>
